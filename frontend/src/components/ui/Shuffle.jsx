...
// Fallback SplitText implementation for environments where GSAP SplitText is non-Club
class FallbackSplitText {
  constructor(element, options = {}) {
    ...
    const charsClass = options.charsClass || 'shuffle-char';
  ...
  revert() {
    if (this.element && this.originalText !== null) {
...
const GSAPSplitText = FallbackSplitText;
    ...
    () => {
      ...
      const build = () => {
        ...
        chars.forEach(ch => {
          ...
          const w = ch.getBoundingClientRect().width || 12;
          const h = ch.getBoundingClientRect().height || 20;
          if (!w) return;
